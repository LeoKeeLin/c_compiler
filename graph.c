	...
	)
{
	...
	switch (p->type)
	{
		case typeCon:	sprintf (word, "c(%.3f)", p->con.value); break;
		...
		case typeOpr:
			switch (p->opr.oper)
			{
				...
				case V:			s = "print all variable in all form\n"; break;
				case W:			s = "print all variable\n"; break;
				case X: 		s = "print_bin"; break;
				case Y: 		s = "print_oct"; break;
				case Z: 		s = "print_hex"; break;
				case RESET: 	s = "all variable reset"; break;
